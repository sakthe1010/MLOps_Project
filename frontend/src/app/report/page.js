...
export default function ReportPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-green-200 to-blue-200 p-6 flex items-center justify-center">
        <div className="max-w-4xl bg-white p-8 rounded-lg shadow-md w-full">
          <h1 className="text-3xl font-bold text-center text-black mb-6">Test Report</h1>
          ...
          {recommendations.length > 0 && (
            <div className="mt-8 p-4 bg-yellow-100 border border-yellow-400 rounded">
              <h2 className="text-lg font-semibold text-black mb-3">📌 Recommended Chapters to Revise:</h2>
